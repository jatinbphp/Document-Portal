            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url('users/edit/'.$user_data['id']) ?>" method="post"  id="admin_user_edit_form" enctype="multipart/form-data">
                                   ...
                                   <div class="col-md-6">
                                    <div class="uploadImage">
                                        <?php if($user_data['image'] != ''){ ?>
                                            <img id="output1" class="myImg" onclick="myFunction1(1);" height="100" src="<?php echo base_url('uploads/users/'.$user_data['primimage']); ?>" /> 
                                        <?php }else{ ?>
                                      ...
                                      <span>  (Only accept .png and .jpg image)</span>
                                        ...
                                        <div class="uploadImage">
                                            <?php if($user_data['image'] != ''){ ?>
                                                <img id="output2"class="myImg" onclick="myFunction1(2);"  height="100" src="<?php echo base_url('uploads/users/'.$user_data['image']); ?>" /> 
                                            <?php }else{ ?>
                                    ...
                                    <input type="hidden" id="hidden_image1" name="hidden_image1" value="<?php if(isset($user_data['image'])){ echo $user_data['image']; } ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="firstName" name="firstName" placeholder="firstname" autocomplete="off" REQUIRED value="<?php echo $user_data['firstName'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="lastname">Last Name :<span class="asterisk-sign">*</span></label>
                                                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="lastname" autocomplete="off" REQUIRED value="<?php echo $user_data['lastName'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row  ">
                                        <div class="col-12">
                                            ...
                                            <div class="mb-4 col-sm-6 d-flex flex-wrap">
                                             ...
                                             <div class="row  ">
                                            <div class="mb-3 col-sm-6 d-flex flex-wrap">
                                            ...
                                            ?>
                                            <div class="mb-3">
                                                <label class="fieldlabel">Hijab Preference</label>
                                                <div class="radio-group mt-4">
                                                    <?php
                                    ...
                                    <div class="row ">
                                        <div class="col-12  ">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                ?>
                                                <input type="radio" name="willingToRelocate" class="one_required" id="WillingToTelocate_<?php echo $key;?>" value="<?php echo $value;?>" <?php echo $slct;?>> <?php echo $value;?><br>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                echo '<br><input type="checkbox" class="one_required" name="LivingArrangements[]" value="'.$GetRec["id"].'" '.$slct.' > '.$GetRec["desc"];
                                                }
                                                ?>
                                                <br><input type="text" name="LivingArrangements_OTHER" id="LivingArrangements_OTHER" value="" disabled="disabled" class="form-control">
                                            </div>
                                            <div class="mb-3">
                ...
                ?>
                <br><input type="checkbox" name="MosqueFrequency[]" class="one_required" value="-1"> Other&nbsp;<input type="text" name="mosqueVisitOther" disabled="disabled" id="mosqueVisitOther" value="" class="form-control">
                                                </div>
...
<script type="text/javascript">
$(document).ready(function() {
$("#malecandidate").addClass('activAcc');
$("#guiding_male").children('a').addClass('active');
$('#male').addClass('show');
