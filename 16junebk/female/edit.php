...
<main class="male-condidates">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            .accordion .d-flex textarea,
            .accordion .d-flex input[type="text"],
            .accordion .d-flex .select-wrapper.w-100 {
                width: 100%;
            }
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="female_profile_form" action="<?php echo base_url('dashboard/female_edit_profile') ?>" method="post" enctype="multipart/form-data">
                            <div class="row justify-content-center">
                                <div class="col-md-9 pt-4">
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Login details <div class="px-2"> *</div></button>
                                            </h2>
                                                    ...
                                                    <div class="card border-0">
                                                        <div class="card-body text-left">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap imgUp ">
                                                                        <div class="imageborder" style=" width: 100%;">
                                                                            <div class="pull-left">
                                                                                <?php 
                                                                                if($user_data['image'] != ''){ ?>
                                                                                <img id="output1" height="100" src="<?php echo base_url('uploads/female/'.$user_data['primimage']); ?>" title="please select a recent photograph of yourself.  If you feel uncomfortable sharing a photo, choose something that represents you i.e. a sunset, or kitten.  Candidates with actual photos of themselves, have a higher success rate getting matched."/>
                                                                                <?php 
                                                                                }else{ ?>
                                                                                <img id="output1" height="100" src="<?php echo base_url('assets/images/female.jpeg'); ?>" title="please select a recent photograph of yourself.  If you feel uncomfortable sharing a photo, choose something that represents you i.e. a sunset, or kitten.  Candidates with actual photos of themselves, have a higher success rate getting matched."/>
                                                                                <?php 
                                                                                } ?>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap imgUp">
                                                                        <div class="imageborder" style=" width: 100%;">
                                                                            <div class="pull-left">
                                                                                <?php 
                                                                                if($user_data['image'] != ''){ ?>
                                                                                <img id="output2" height="100" src="<?php echo base_url('uploads/female/'.$user_data['image']); ?>" title="please select a recent photograph of yourself.  If you feel uncomfortable sharing a photo, choose something that represents you i.e. a sunset, or kitten.  Candidates with actual photos of themselves, have a higher success rate getting matched."/>
                                                                                <?php 
                                                                                }else{ ?>
                                                                                <img id="output2" height="100" src="<?php echo base_url('assets/images/female.jpeg'); ?>" title="please select a recent photograph of yourself.  If you feel uncomfortable sharing a photo, choose something that represents you i.e. a sunset, or kitten.  Candidates with actual photos of themselves, have a higher success rate getting matched."/>
                                                                                <?php 
                                                                                }  ?>
                                                                            </div>
                                                                            <div class="pull-right">
                                                            ...
                                                            <div class="row justify-content-center">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        <label class="fieldlabelfirst">Ethnicity - Which Ethnicity would you like your spouse to be?</label>
                                                                        <div class="radio-group mt-1">
                                                                            <?php
                                                            ...
                                                            <div class="row justify-content-center">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        <label class="fieldlabelfirst">Hijab Preference <span class="required_sign">*</span></label>
                                                                        <div class="radio-group mt-1">
                                                                            <?php
                                                                            ...
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label">
                                                                                    <input class="form-check-input one_required" type="radio" name="hijabPreferenceID" value="<?php echo $GetRec["id"];?>"
                                                                                    <?php echo $slct;?>>
                                                                        ...
                                                                        <label>Any additional hijab details you would like to include</label>
                                                                ...
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        ...
                                                                        <div class="radio-group mt-1">
                                                                            ...
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label">
                                                                                    <input required class="form-check-input one_required" type="radio" name="highestEducationLevelID" value="<?php echo $GetRec["id"];?>"
                                                                                    <?php echo $slct;?>>
                                                                ...
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <div class="radio-group mt-1">
                                                                            ...
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label">
                                                                                    <input class="form-check-input one_required" type="radio" name="maritalStatusID" value="<?php echo $GetRec["id"];?>"
                                                                                    <?php echo $slct;?>>
                                                            ...
                                                            <div class="row justify-content-left">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <div class="form-check form-check-inline">
                                                                            <label class="form-check-label">
                                                                                <input type="radio" name="willingToRelocate" class="one_required" id="WillingToTelocate_<?php echo $key;?>" value="<?php echo $value;?>" <?php echo $slct;?>>
                                                            ...
                                                            <div class="row justify-content-left">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <br><input type="text" name="LivingArrangements_OTHER" disabled="disabled" id="LivingArrangements_OTHER" value="" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row justify-content-left">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <br> <input type="text" name="LivingStyle_OTHER" disabled="disabled" id="LivingStyle_OTHER" value="" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row justify-content-left">
                                                                ...
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <div class="radio-group mt-4">
                                                                            ...
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label">
                                                                                    <input class="form-check-input" type="radio" name="hijabPreferenceID" value="<?php echo $GetRec[" id"];?>"
                                                                                    <?php echo $slct;?>>
                                                                                    <?php echo $GetRec["hijabPreferenceName"];?>
                                                                                </label>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8">
                                                                        <label class="fieldlabelfirst">Any additional hijab details you would like to include</label>
                                                                        <textarea name="hijabPreferenceAdditional" id="hijabPreferenceAdditional" placeholder="" class="form-control"><?php echo $user_data['hijabPreferenceAdditional']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row justify-content-left">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        <input type="radio" class="one_required" name="considerDivorcee" id="consideradivorcee_<?php echo $key;?>" value="<?php echo $value;?>" <?php echo $slct;?>> <span class="checkbox_lable">
                                                                            <?php echo $value;?></span><br>
                                                                        <?php
                                                                        } ?>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3 plr-8">
                                                                        ...
                                                                        foreach ($MosqueVisits as $GetRec){
                                                                            ...
                                                                            $dwhereEqual = array('fcid'=>$user_data["id"]);
                                                                            $agselectColumn['*'] = '*';
                                                                            $MosqueVisits1 = $this->model_common->getMultipleDataByField('FC_MosqueVisits',$agselectColumn,$dwhereEqual);


                                                                            // $mshereEqual = array('mcid'=>$user_data["id"]);
                                                                            // $msselectColumn['*'] = '*';
                                                                            // $MosqueVisits1 = $this->model_common->getMultipleDataByField('MC_MosqueVisits',$msselectColumn,$mshereEqual);
                                                                            $slct="";?>
                                                                            <?php
                                                                            if(!empty($MosqueVisits1)){
                                                                                foreach ($MosqueVisits1 as $key => $value) {
...
$("#female_profile_form").validate({
    ...
    rules: {
        ...
        LivingArrangements_OTHER:{
            required: function(){
                if ($('input[name="LivingArrangements[]"]:checked').val()==11) {
                    return true;
                }else{
                    return false;
                }
        ...
        LivingStyle_OTHER:{
            required: function(){
                if ($('input[name="LivingStyle[]"]:checked').val()==5) {
                    return true;
                }else{
                    return false;
                }
...
function saveAndCompleteLater()
    {
        $("#female_profile_form").validate().settings.ignore = "*";
        $('#female_profile_form').submit();
    }
