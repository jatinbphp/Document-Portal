                                                            ...
                                                            <div class="row justify-content-center">
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap imgUp">
                                                                        ...
                                                                        <img id="output1" height="100" src="<?php echo base_url('uploads/female/'.$user_data['primimage']); ?>" />
                                                                        <?php }else{ ?>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap imgUp">
                                                                        <?php if($user_data['image'] != ''){ ?>
                                                                        <img id="output2" height="100" src="<?php echo base_url('uploads/female/'.$user_data['image']); ?>" />
                                                                        <?php }else{ ?>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        <input type='text' name="firstName" minlength="3" id="firstName" value="<?php echo $user_data['firstName'] ?>" placeholder="First Name" class="form-control" /> <div class="px-2"> *</div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        <input type='text' minlength="3" name="lastName" id="lastName" placeholder="Last Name" value="<?php echo $user_data['lastName'] ?>" class="form-control" /> <div class="px-2"> *</div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        ...
                                                                        <input type="text" name="personalEthnicityOther" id="personalEthnicityOther" placeholder="personal Ethnicity Other" value="<?php echo $user_data['personalEthnicityOther']; ?>" class="form-control" <?php if((int)$user_data['personalEthnicityID']!=9){ echo "disabled"; } ?>>
                                                                    </div>
                                                                    <?php
                                                                ...
                                                                <div class="col-12 d-flex flex-wrap">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 plr-8 d-flex flex-wrap">
                                                                        ...
                                                                        <div class="radio-group mt-1">
                                                                            ...
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label">
                                                                                    <input required class="form-check-input" type="radio" name="highestEducationLevelID" value="<?php echo $GetRec["id"];?>" <?php echo $slct;?>>
