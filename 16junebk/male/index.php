            ...
            <!-- left column -->
                ...
                <!-- general form elements --> 
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-20">
                        <?php if($this->session->userdata('candidategender') =='male'){  ?>
                             ...
                             <div class="col-sm-8">
                                  ...
                                  <hr>
                                            <div class="col-sm-8 mb-4">
                                                <label class="fieldlabel">Hijab Status</label>
                                                <div class="radio-group ">
                                                    <?php foreach ($HijabPreference as $GetRec)
                                                {  ?>
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input hijabPreferenceIDClass" type="checkbox" name="hijabPreferenceID[]"  value="<?php echo $GetRec["id"];?>" >
