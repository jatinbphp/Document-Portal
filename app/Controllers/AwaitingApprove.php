...
class AwaitingApprove extends BaseController{

	public function index(){
		 $userId = $_SESSION['id'];

        $this->data['page_title'] = 'SubadminWorkflow';
        $this->render_user_template('Ceo/awating_approval/index', $this->data);
	}

	public function fetch_ceo_company_data(){
        ...
        foreach ($fetch_data as $key => $row) {
            ...
            $url = base_url('/CeoAwatingView/index/'.$row['company_id']);
