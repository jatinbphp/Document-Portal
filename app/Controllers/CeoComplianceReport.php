...
class CeoComplianceReport extends BaseController{

	public function index(){
		 $userId = $_SESSION['id'];

        $this->data['page_title'] = 'CeoComplianceReport';
        $this->render_user_template('Ceo/compliance_report/index', $this->data);
	}

	public function fetch_ceo_compliance_report(){
