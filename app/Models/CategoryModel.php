...
class CategoryModel extends Model
{
    ...
    public function getActionLink($path,$id,$type,$view=null,$userdelete=null){
        ...
        $actionLinkVar .= '<a href="' . base_url( 'category/delete/'.$id). '" title="Delete User Types" class="btn btn-danger deleteData deleteCategory" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;" data-id="' . $id . '"><i class="fa fa-trash"></i></a>';
