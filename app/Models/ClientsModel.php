...
class ClientsModel extends Model
{
	...
	protected $allowedFields = ['first_name','last_name','email','psw','is_active'];
    ...
    public function getActionLink($path,$id,$type,$view=null,$userdelete=null){
        ...
        $actionLinkVar .= '<a title="Edit Clients" href="' . base_url( 'clients/edit/'.$id). '" class="btn btn-warning" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;"><i class="fa fa-edit"></i></a>';

        
        $actionLinkVar .= '<a href="' . base_url( 'clients/delete/'.$id). '" title="Delete User Types" class="btn btn-danger deleteData deleteClients" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;" data-id="' . $id . '"><i class="fa fa-trash"></i></a>';
