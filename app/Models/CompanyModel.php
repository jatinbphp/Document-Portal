...
class CompanyModel extends Model
{
	...
	protected $allowedFields = ['companyName','client_id'];
    ...
    public function getActionLink($path,$id,$type,$view=null,$userdelete=null){
        ...
        $actionLinkVar .= '<a title="Edit Company" href="' . base_url( 'company/edit/'.$id). '" class="btn btn-warning" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;"><i class="fa fa-edit"></i></a>';

        
        $actionLinkVar .= '<a href="' . base_url( 'company/delete/'.$id). '" title="Delete User Types" class="btn btn-danger deleteData deleteCompany" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;" data-id="' . $id . '"><i class="fa fa-trash"></i></a>';
