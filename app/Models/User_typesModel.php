...
class User_typesModel extends Model
{
	...
	protected $allowedFields = ['userTypeName'];
    ...
    public function getActionLink($path,$id,$type,$view=null,$userdelete=null){
        ...
        $actionLinkVar .= '<a title="Edit User Types" href="' . base_url( 'user_types/edit/'.$id). '" class="btn btn-warning" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;"><i class="fa fa-edit"></i></a>';

        
        $actionLinkVar .= '<a href="' . base_url( 'user_types/delete/'.$id). '" title="Delete User Types" class="btn btn-danger deleteData deleteUsertypes" style="margin: 0px 5px 5px 0px;padding: 4px 9px;font-size: 14px;" data-id="' . $id . '"><i class="fa fa-trash"></i></a>';
