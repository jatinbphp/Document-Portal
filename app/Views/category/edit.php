    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="item-wrap item-list-table">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="companyFormAddEdit" method="post" action="<?php echo base_url('category/edit/'.$category['id']); ?>" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="lableTitle"for="companyName">Category Name :<span class="asterisk-sign">*</span></label>
                                        <input type="text" name="categoryName" class="form-control" id="companyName" value="<?php echo $category['categoryName'] ?>" placeholder="Category Name">
                                    </div>
                                </div>
                            </div>
