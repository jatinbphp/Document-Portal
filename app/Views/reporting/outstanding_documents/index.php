...
<div class="wrapper">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3>Outstanding Documents <!--a class="btn btn-info" style="float: right;" href="<?php echo base_url('workflow/add'); ?>">Add Workflow</a--></h3>

            <div class="item-wrap item-list-table">
                <table id="outstandingDocumentsTable" class="table table-bordered" cellspacing="0" width="100%" >
...
<script type="text/javascript">
  // $(".manageDocuments-Menu .inner").addClass("show");
    ...
    $("#outstandingDocumentsReport").addClass('active'); 
    $(".Reporting-Menu").addClass('active');
