<div class="wrapper">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3>Uploaded Documents <!--a class="btn btn-info" style="float: right;" href="<?php //echo base_url('documents/add'); ?>">Upload Documents</a--></h3>

            <div class="item-wrap item-list-table">
                <table id="uploadedDocuments" class="table table-bordered" cellspacing="0" width="100%" >
