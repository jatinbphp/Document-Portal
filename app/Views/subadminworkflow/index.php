        ...
        <div class="col-sm-12">
            ...
            <h3>
             ...
             <div class="item-wrap item-list-table">
                <table id="users111Table" class="table table-bordered" cellspacing="0" width="100%" >
                    <thead class="thead-dark">
                        <tr>
                            <th style="width: 15%">Company</th>
                        </tr>
                         <tr>
                            <td><a href = "<?php echo base_url('/workflow');?>">Nxsol</a></td>
                            
                        </tr>
                         <tr>
                            <td><a href = "<?php echo base_url('/workflow');?>">GMDS</a></td>
