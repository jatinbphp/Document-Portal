<div class="sidebar">
	<div class="sidebar-menu">
		...
		<ul class="accordion">
			...
			<li class="manageUsers-Menu">
              	<a class="toggle" href="javascript:void(0)"><img src="<?php echo base_url('assets/images/dash-icon-5.png');?>" alt="">Manage Users</a>
              	<ul class="inner">
                    <li class="Users-Menu"><a class="" href="<?php echo base_url('users'); ?>"><img src="<?php echo base_url('assets/images/dash-icon-5.png'); ?>" alt=""> Users</a></li>
                </ul>
