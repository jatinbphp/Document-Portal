<div class="wrapper">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3>Manage User Types <a class="btn btn-info" style="float: right;" href="<?php echo base_url('user_types/add'); ?>">Add User Type</a></h3>

            <div class="item-wrap item-list-table">
                <table id="user_typesTable" class="table table-bordered" cellspacing="0" width="100%">
